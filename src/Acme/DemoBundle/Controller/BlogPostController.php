...
use Acme\DemoBundle\Form\BlogPostType;
...
class BlogPostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeDemoBundle:BlogPost')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeDemoBundle:BlogPost:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeDemoBundle:BlogPost')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeDemoBundle:BlogPost:edit.html.twig")
     */
